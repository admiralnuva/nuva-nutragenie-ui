              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {pantryDishes.slice(0, 4).map((dish, index) => {
                    ...
                    const handleDishSelect = (selectedDishId: string | number) => {
                      if (!isDisabled) {
                        toggleDishSelection(selectedDishId as string);
                        // Auto-add ingredients to shopping cart
                        // This will be handled by the cart logic
                      }
                    };

                    const handleSubstitutions = (selectedDishId: string | number) => {
                      // TODO: Navigate to substitutions view
                      console.log('Substitutions for:', selectedDishId);
                    };

                    const handleViewRecipe = (selectedDishId: string | number) => {
