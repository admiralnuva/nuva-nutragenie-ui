    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white p-4 pb-24">
      ...
      <div className="space-y-6">
        ...
        <div className="mb-3 border border-gray-600 rounded-lg p-3 space-y-2">
            ...
            >
              <div className="flex items-center h-full">
                <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0 -ml-6">
            ...
            >
              <div className="flex items-center h-full">
                <div className="w-10 h-10 bg-amber-600 rounded-lg flex items-center justify-center flex-shrink-0 -ml-6">
                  <span className="text-lg">🏠</span>
                </div>
                <div className="ml-3 text-left flex-1 min-w-0">
            ...
            >
              <div className="flex items-center h-full">
                <div className="w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center flex-shrink-0 -ml-6">
                  <span className="text-lg">🎨</span>
                </div>
                <div className="ml-3 text-left flex-1 min-w-0">
            ...
            >
              <div className="flex items-center h-full">
                <div className="w-10 h-10 bg-emerald-600 rounded-lg flex items-center justify-center flex-shrink-0 -ml-6">
                  <span className="text-lg">📦</span>
                </div>
                <div className="ml-3 text-left flex-1 min-w-0">
        ...
        <div className="mt-16 mb-3 border border-gray-600 rounded-lg p-3 space-y-2">
          ...
          >
            <div className="flex items-center h-full">
              <div className="w-10 h-10 bg-teal-600 rounded-lg flex items-center justify-center flex-shrink-0 -ml-4">
                <span className="text-lg">🥬</span>
              </div>
              <div className="ml-3 text-left flex-1 min-w-0">
