        ...
        <div className="grid grid-cols-3 gap-x-6 gap-y-3 max-w-md mx-auto">
          {recipeOptions.map((option) => {
            ...
            return (
              ...
              >
                <div className={`w-28 h-28 ${option.color} rounded-2xl flex items-center justify-center shadow-lg hover:scale-105 transition-transform`}>
                  <IconComponent size={54} className="text-white" />
                </div>
