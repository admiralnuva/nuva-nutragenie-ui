  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 bg-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <div className={`w-2 h-2 rounded-full ${isConnected ? 'bg-purple-500' : 'bg-red-500'}`} />
        ...
        {/* Mute Button and Voice Options - aligned */}
        <div className="flex items-center gap-2">
          {/* Mute Chef Button - aligned with voice options */}
          <button
      ...
      {/* Message Input */}
      <div className="fixed bottom-24 left-0 right-0 z-40 px-8">
