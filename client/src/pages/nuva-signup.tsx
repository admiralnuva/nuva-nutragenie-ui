  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="p-4 space-y-4 max-w-md mx-auto" style={{ paddingBottom: '40px' }}>
        ...
        {/* Profile Card */}
        <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl p-6 mb-6 border border-gray-700 border-l-4 border-l-purple-500 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 hover:scale-[1.02] hover:border-l-purple-400">
