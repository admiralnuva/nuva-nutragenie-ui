            ...
            return (
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-4 text-xs mb-3">
                  <span className="text-orange-600 font-semibold">{Math.round(calculateDishNutrition(dish.id).calories)} cal</span>
                  <span className="text-blue-600 font-semibold">{Math.round(calculateDishNutrition(dish.id).protein)}g protein</span>
                  <span className="text-green-600 font-semibold">{Math.round(calculateDishNutrition(dish.id).carbs)}g carbs</span>
                  <span className="text-purple-600 font-semibold">{Math.round(calculateDishNutrition(dish.id).fat)}g fat</span>
                </div>
        ...
        <Card className="mt-6">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Nutrition Tracking
              <Badge variant="secondary">{selectedDishesForAction.length} dishes selected</Badge>
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-0">
            {/* Daily Goals vs Selected Dishes */}
            <div className="space-y-4">
              {/* Goals Display - Always Show */}
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-purple-50 p-2 rounded-lg border border-purple-200">
                    <div className="text-xs text-purple-700">Fiber (g)</div>
              ...
              {/* Daily meal plan nutrition comparison - always show */}
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2">Daily Meal Plan Analysis</h4>
                <div className="space-y-3">
                  <div className="text-xs text-gray-600 mb-2">
                    Select dishes to see nutrition analysis
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-blue-100 p-2 rounded-lg border border-blue-300">
                      ...
                      <div className="text-lg font-bold text-blue-800">—g</div>
                    </div>
                  </div>
                </div>
